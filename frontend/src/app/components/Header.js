...
export default function Header() {
    ...
    // ✅ 수정: Provider에서 unreadCount와 handleOpenMailbox를 가져옵니다.
                        ...
                        {user && (
                            <>
                                <span className="text-gray-700 font-semibold flex items-center">
                                    {user.role === 'super_admin' && <span className="text-blue-500 font-bold mr-1">[관리자]</span>}
                                    {user.nickname}님
                                </span>
                                <button
                    ...
                    <nav className="flex flex-col p-4 space-y-1">
                        ...
                        {user && (
                            <>
                                ...
                                <button
                                    onClick={logout}
                                    className="p-3 text-left rounded-md font-semibold text-red-500 hover:bg-red-50"
                                >
                                    로그아웃
                                </button>
                            </>
